...
<div class="container bg-white mt-5">
    ...
    <div class="row">
        ...
        <a class="col-lg-3 col-sm-6 d-flex flex-column align-items-center justify-content-center product-item my-3"
            href="{{ route('products.detail', ['idProduct'=> $product->productCode ]) }}">
